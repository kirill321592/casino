...
import { WHEEL_SIZE, SPIN_DURATION_MS } from '@/shared/config/wheelConstants'
import { animateSpin } from '../lib/animateSpin'
import { centerWheelScene, createWheelScene, type WheelScene } from '../lib/createWheel'
...
export const PixiRoulette = forwardRef<PixiRouletteHandle, PixiRouletteProps>(
  function PixiRoulette({ className }, ref) {
